        ...
        <div class="main-content">
            ...
            <section class="overview">
                <?php
                    ...
                    $sql = "SELECT O.ownerName, P.propertyAddress, P.salePrice, P.marketPrice, P.propertyType, P.propertyCountry, P.city, P.costPaidBySeller, P.closingDate, P.details FROM property P, owner O where O.ownerID = P.ownerID";
                    $stmt = $conn->prepare($sql);
                    $stmt->execute();
                    $result = $stmt->get_result();
                    echo "<table border='1' style = 'width:100%;'>";
                    echo "<tr><th>Owner</th><th>Address</th><th>Sale Price</th><th>Market Price</th><th>Property Type</th><th>Country</th><th>City</th><th>Cost Paid by Seller</th><th>Closing Date</th><th>Details</th></tr>";
