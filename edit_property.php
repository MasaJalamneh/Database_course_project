                ...
                <div class="login-container">
                    ...
                    <form method="POST" action="">
                        ...
                        <select name="attribute_to_update" id="attribute_to_update">
                            ...
                            <option value="propertyCountry">Country</option>
                            <option value="city">City</option>
                            <option value="costPaidBySeller">Cost Paid by Seller</option>
                    ...
                    if ($_SERVER["REQUEST_METHOD"] === "POST") {
                        ...
                        if ($propertyID && $attribute_to_update && $new_value) {
                            $sql = "UPDATE property SET $attribute_to_update = ? WHERE propertyID = ?";
                            $res = $conn->prepare($sql);
                            $res->bind_param("si", $new_value, $propertyID); 
                            if ($res->execute()) {
                                echo "<div style='display: flex; justify-content: center; align-items: center; height: 100vh; text-align: center; flex-direction: column; color: red; font-size: 30px'>property updated successfully!</div><br>";
                            } else {
                                echo "Error updating property: " . $res->error . "<br>";
                            }
                            $res->close();
                        } else {
